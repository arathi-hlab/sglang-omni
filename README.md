...
| Area | Links |
|---|---|
| Get started | [Installation](./docs/get_started/installation.md) · [Apple Silicon](./docs/get_started/installation.md#macos-apple-silicon) · [Quick Start](#quick-start) · [Supported models](./docs/supported_models.md) |
